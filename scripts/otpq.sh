...
curl "http://54.175.14.6:8080/otp/routers/default/plan?fromPlace=1%3A124&toPlace=1%3A105&mode=TRANSIT%2CWALK&maxWalkDistance=804.672&wheelchair=false&locale=en&numItineraries=5&showIntermediateStops=true"
